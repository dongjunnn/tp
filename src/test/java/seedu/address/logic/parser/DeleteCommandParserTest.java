...
public class DeleteCommandParserTest {
    ...
    @Test
    public void parse_multipleArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, "1 2",
                new DeleteCommand(Arrays.asList(INDEX_FIRST_PERSON, INDEX_SECOND_PERSON)));
    }

    @Test
    public void parse_threeArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, "1 2 3",
                new DeleteCommand(Arrays.asList(INDEX_FIRST_PERSON, INDEX_SECOND_PERSON, INDEX_THIRD_PERSON)));
    }
    ...
    @Test
    public void parse_argsWithExtraWhitespace_returnsDeleteCommand() {
        assertParseSuccess(parser, "  1   2  ", new DeleteCommand(Arrays.asList(INDEX_FIRST_PERSON,
                            INDEX_SECOND_PERSON)));
    }
