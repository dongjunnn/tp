...
public class CommandTestUtil {
    ...
    public static final String VALID_DISCORD_AMY = "amy#1234";
    ...
    public static final String VALID_PRIORITY_AMY = "100";
    public static final String VALID_PRIORITY_BOB = "100";
    ...
    public static final String DISCORD_DESC_AMY = " " + PREFIX_DISCORD + VALID_DISCORD_AMY;
    ...
    public static final String INVALID_PRIORITY_DESC = " " + PREFIX_PRIORITY + "-1"; // negative integers are not allowed
