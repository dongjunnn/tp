...
import static seedu.address.logic.commands.CommandTestUtil.DISCORD_DESC_AMY;
...
import static seedu.address.logic.commands.CommandTestUtil.YOUTUBE_DESC_AMY;
...
public class LogicManagerTest {
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + DISCORD_DESC_AMY + LINKEDIN_DESC_AMY
                + INSTAGRAM_DESC_AMY + YOUTUBE_DESC_AMY + PRIORITY_DESC_AMY + ADDRESS_DESC_AMY;
