 ...
 * Shows person details including name, contact information, tags, and associated projects.
 * Projects are displayed as clickable hyperlinks if the projects FlowPane exists.
 */
public class PersonCard extends UiPart<Region> {
     ...
     * @param person The person to display. Must not be null.
     * @param displayedIndex The 1-based index to display. Must be positive.
     * @param allProjects The list of all projects to check for membership. Can be null.
     * @param onProjectClick Callback to execute when a project is clicked. Can be null.
     */
    public PersonCard(Person person, int displayedIndex,
     ...
     * @param onProjectClick The callback to execute when a project is clicked. Must not be null.
     */
